...
def get_cli_arguments():
    ...
    parser = builder.get_arg_parser("pbc", "0.5.14", 1, __file__, [builder.TARGET_LINUX_x86_64, builder.TARGET_LINUX_arm64_v8a])
...
if __name__ == "__main__":
    ...
    builder.fetch_source(
        args=args,
        source=f"https://crypto.stanford.edu/pbc/files/pbc-{args.version}.tar.gz",
        extract="tar.gz",
    )

    source_dir = os.path.join(args.source_dir, f"pbc-{args.version}")
